...
var CmsStaticPage = /** @class */ (function (_super) {
    ...
    CmsStaticPage._load = function (assetId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new crownpeak_dxm_sdk_core_1.CmsStaticDataProvider().getSingleAsset(assetId)];
                    case 1:
                        _a.sent();
    ...
    CmsStaticPage.load = function (assetId, useState, useEffect) {
        var _this = this;
    ...
    CmsStaticPage.loadSync = function (assetId) {
        new crownpeak_dxm_sdk_core_1.CmsStaticDataProvider().getSingleAssetSync(assetId);
        crownpeak_dxm_sdk_core_1.CmsDataCache.cmsAssetId = assetId;
    };
    return CmsStaticPage;
}(cmsPage_1.default));
exports.default = CmsStaticPage;
//# sourceMappingURL=cmsStaticPage.js.map